(function bootstrapSiteData(globalScope, factory) {
  ...
  const doctors = [
    {
      ...
      categories: ['restorative', 'esthetic'],
      image: images.orange,
      experience: 14,
    ...
    },
    {
      ...
      categories: ['endodontics', 'restorative'],
      image: images.orange,
      experience: 10,
    ...
    },
    {
      ...
      specialty_ru: 'Детская и профилактическая стоматология',
      categories: ['pediatric', 'preventive'],
      image: images.orange,
      experience: 9,
      education: '2015 - Dentistry, Semey Medical University<br>2017 - Pediatric dentistry program and behavior guidance training',
      education_ru: '2015 - Стоматология, Медицинский университет Семей<br>2017 - Программа по детской стоматологии и поведенческому сопровождению',
      spec: 'Adaptation visits, minimally invasive treatment, fissure sealants, and family prevention plans.',
      spec_ru: 'Адаптационные визиты, малоинвазивное лечение, герметизация фиссур и семейные профилактические планы.'
    },
    {
      id: 6,
    ...
    },
    {
      ...
      specialty: 'Digital prosthodontics and smile design',
      specialty_ru: 'Цифровая ортопедия и дизайн улыбки',
      categories: ['digital', 'prosthodontics'],
      image: images.orange,
      experience: 8,
      education: '2016 - Dentistry, Nazarbayev University School of Medicine<br>2019 - CAD/CAM and digital prosthodontics certification',
      education_ru: '2016 - Стоматология, Nazarbayev University School of Medicine<br>2019 - Сертификация по CAD/CAM и цифровой ортопедии',
      spec: 'Digital mockups, crowns and veneers, scan-based workflows, and patient presentation protocols.',
      spec_ru: 'Цифровые мокапы, коронки и виниры, протоколы на основе сканов и презентация плана пациенту.'
    },
    {
      id: 8,
      name: 'Dr. Alikhan Mirasov',
      specialty: 'Oral surgery and sedation support',
      specialty_ru: 'Хирургическая стоматология и седация',
      categories: ['surgery', 'sedation'],
      image: images.blue,
      experience: 10,
      education: '2014 - Dentistry, Astana Medical University<br>2018 - Oral surgery and sedation support training',
      education_ru: '2014 - Стоматология, Astana Medical University<br>2018 - Подготовка по хирургической стоматологии и сопровождению седации',
      spec: 'Atraumatic extraction, impacted teeth, surgical planning, and complex care coordination.',
      spec_ru: 'Атравматичное удаление, ретинированные зубы, хирургическое планирование и координация сложных случаев.'
    }
  ];
  ...
  const lecturers = [
    ...
    {
      id: 106,
      name: 'Prof. Aigerim Bektassova',
      specialty: 'Lecturer in pediatric workflow',
      specialty_ru: 'Лектор по детскому клиническому протоколу',
      categories: ['pediatric', 'preventive'],
      image: images.orange,
      experience: 15,
      education: 'Teaches behavior guidance, parent communication, sedation routing, and prevention systems.',
      education_ru: 'Преподает поведенческое сопровождение, коммуникацию с родителями, маршрутизацию в седацию и профилактические системы.',
      spec: 'Focuses on chairside adaptation and predictable child-friendly treatment flow.',
      spec_ru: 'Специализируется на адаптации ребенка в кресле и предсказуемом детском лечебном маршруте.'
    }
  ];
